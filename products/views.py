...
def add_product(request):
    ...
    if not request.user.is_superuser:
        messages.error(request, 'Only authorised accounts can add products.')
...
def edit_product(request, product_id):
    ...
    if not request.user.is_superuser:
        messages.error(request, 'Only authorised accounts can edit products.')
        return redirect(reverse('home'))
...
def delete_product(request, product_id):
    ...
    if not request.user.is_superuser:
        messages.error(request, 'Only authorised accounts can delete products.')
        return redirect(reverse('home'))
